...
fp.puts ""
fp.puts "[Data]"
fp.puts "Sample_ID,Sample_Name,Sample_Plate,Sample_Well,I7_Index_ID,index,I5_Index_ID,index2,Sample_Project,Description"
...
File.open(fn).each_line do |line|
	...
	fp.puts "#{id},,,,#{i7_id},#{i7_index},#{i5_id},#{i5_index},,"
end
